                    ...
                    <SignedOut>
                        <div className='flex gap-2'>
                            <SignInButton mode='modal'>
                                <Button variant={"outline"} size={"sm"} className="border-primary/30 hover:border-primary/60 hover:bg-primary/10">
                                    Sign In
                                </Button>
                            </SignInButton>
                            <SignUpButton mode='modal'>
                                <Button size={"sm"} className="bg-primary hover:bg-primary/80 text-primary-foreground font-semibold">
                                    Get Started
                                </Button>
                            </SignUpButton>
                        </div>
