"use client";
import { useGetProjects } from "@/modules/projects/hooks/project"; // ✅ Fixed typo 'hoooks'
...
const ProjectList = () => {
    ...
    if (isPending) {
        return (
            <div className="w-full mt-16">
                <h2 className="text-2xl md:text-3xl font-bold text-center mb-8">Your Past Cooks</h2> {/* ✅ Fixed 'mb--8' */}
    ...
    return (
        <div className="w-full mt-16">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-8">Your Cooks</h2>
            ...
            <div className="lg:hidden max-w-4xl mx-auto px-4">
                ...
                >
                    <CarouselContent className="-ml-4">
                        {projects.map((project) => (
                            // ✅ FIX: CarouselItem must be the direct child
...
const ProjectCard = ({ project, formatDate }: { project: any, formatDate: any }) => (
    <Card className="group h-full hover:shadow-xl transition-all duration-300 border-zinc-800/50 hover:border-emerald-500/50 cursor-pointer bg-zinc-900/30 backdrop-blur-sm overflow-hidden">
